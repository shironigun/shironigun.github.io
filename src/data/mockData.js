...
export const experience = [
  {
    ...
    company: "Perseus Group, Constellation Software Inc.",
    period: "Jan 2026 — Present",
    duration: "3 months",
    location: "Lahore, Pakistan",
    current: true,
    bullets: [
      "Elevated to <b>QA Lead</b> for the division's flagship CRM product — directing sprint-level quality decisions, owning release readiness, and serving as the primary escalation point across a platform integrated with 4 Dealership Management Systems.",
      "Collaborate with the <b>Product Owner and Initiative Manager</b> to define and refine Epics, User Stories, and acceptance criteria in Azure DevOps — ensuring functional requirements and dealer-facing edge cases are resolved before development begins.",
      "Partner with the <b>UX Designer on mobile application feature designs</b> — validating that every UI decision is grounded in product logic, business requirements, and real dealer workflows prior to development handoff.",
      "Manage <b>sprint board hygiene, task prioritisation, and cross-team dependencies</b> across design, development, and QA — acting as the connective layer that keeps delivery aligned in a squad where roles overlap and accountability is shared.",
      "Led end-to-end <b>QA recruitment evaluation</b> — assessed candidates, identified and recommended the right hire to management, and initiated structured knowledge transfer to ensure team continuity and independent sprint execution.",
    ],
    tags: [
      "Azure DevOps",
      "User Stories",
  ...
  },
  {
    ...
    current: false,
    bullets: [
      "Pioneered the <b>end-to-end design phase</b> for TargetCRM's mobile application — an initiative previously attempted by the Product Delivery Head and Development Manager without success; partnered directly with the UX Designer to ensure every feature design embedded functional and business requirements before reaching development.",
      "Designed and institutionalised a <b>Strict Quality Gates acceptance criteria framework</b> — adopted voluntarily by 3 other product teams across the division, reducing defect leakage by over 40% and eliminating critical production bugs across 6 consecutive sprints.",
      "Assumed full <b>QA ownership of a million-dollar CRM product</b> mid-cycle when the Senior QA transferred without notice — ensured a critical release shipped on time with zero degradation in quality despite no handover period.",
      "Stepped beyond QA to own <b>business analysis responsibilities</b> — writing User Stories, refining requirements with the Product Owner, and defining acceptance criteria during a 3-month BA vacancy; sustained product delivery continuity without interruption.",
      "Designed and delivered <b>2,000+ hours of cross-functional domain training</b> across development, QA, operations, and BA teams — authored the core content of learntargetcrm.com, a self-serve knowledge base now used by internal teams and end customers to compress onboarding from months to days.",
      "Trained and onboarded <b>two QA resources from the ground up</b> — one transitioning from a non-IT domain, one with zero technical background — both reaching independent sprint contribution within their first quarter through structured mentorship.",
    ],
    tags: [
      "Business Analysis",
      "Quality Gates",
  ...
  },
  {
    ...
    current: false,
    bullets: [
      "Initiated and authored the organisation's first <b>Global UI Standards Documentation</b> — establishing component consistency, interaction patterns, and accessibility baselines adopted across the enterprise product suite.",
      "Executed <b>UAT, functional, API, and cross-platform testing</b> across the full sprint lifecycle — proactively identifying workflow inefficiencies and implementing targeted workarounds that reduced regression effort and maintained release stability.",
      "Logged <b>360+ hours of structured collaboration</b> with the Product Owner, Initiative Manager, development, and operations teams — building domain depth that accelerated contribution speed and reduced dependency on senior engineers for context.",
      "Tracked, managed, and resolved <b>bug reports end-to-end</b> within Azure DevOps — ensuring timely defect closure, accurate sprint reporting, and consistent product quality throughout the onboarding period.",
    ],
    tags: [
      "UAT",
      "Functional Testing",
  ...
  },
  {
    ...
    current: false,
    bullets: [
      "Designed and delivered <b>custom WordPress websites</b> for multiple clients — translating brand requirements into fully functional, responsive builds that strengthened client identity and improved end-user engagement.",
      "Converted <b>PSD designs into pixel-perfect WordPress sites</b> — preserving full design integrity through development handoff with zero visual regression between concept and final output.",
      "Built dynamic, mobile-friendly pages using <b>Elementor</b> — optimising responsive layouts and interaction patterns across devices, directly reducing bounce rates and improving cross-platform user experience.",
      "Audited and improved <b>site navigation, layout hierarchy, and UI consistency</b> across all deliverables — applying UX principles that measurably increased on-site engagement and client satisfaction.",
    ],
    tags: [
      "WordPress",
      "Elementor",
  ...
  },
  {
    ...
    current: false,
    bullets: [
      "Designed <b>e-brochures and client-facing marketing materials</b> aligned to brand guidelines — enhancing professional communication and increasing brand visibility across external touchpoints.",
      "Refined the organisation's <b>web interface design</b> — applying user-centred principles to improve navigation clarity, visual hierarchy, and overall platform usability.",
      "Prototyped and sketched <b>UI concepts for stakeholder review</b> — streamlining design-to-development handoff and validating user needs before engineering resources were committed.",
      "Contributed to <b>iterative UX improvements</b> in collaboration with senior designers — applying research-backed design decisions that produced measurable enhancements to the end-user experience.",
    ],
    tags: [
      "UX Design",
      "UI Prototyping",
...
export const testimonials = [
  {
    ...
    role: "R&D Manager, Perseus Group, Constellation Software Inc.",
    initials: "RP",
