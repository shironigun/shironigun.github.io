    ...
    <Tooltip title={tool.name} placement="top" arrow>
      <MotionBox
        ...
        sx={{
          ...
          '&::before': { content: '""', position: 'absolute', inset: 0, background: 'radial-gradient(circle at 50% 0%,var(--accent-glow-mild),transparent 60%)', opacity: 0, transition: 'opacity 0.3s' },
          '&:hover': { borderColor: 'rgba(77,141,255,0.5)', boxShadow: '0 14px 40px var(--accent-glow-strong)', '&::before': { opacity: 1 }, '& .tool-name': { color: 'var(--code-color)' } },
        }}
      >
