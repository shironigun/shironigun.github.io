...
**IMPORTANT**: Uses `projectsData` (detailed format), NOT the simple `projects`
array.

## Type Filters

`All`, `AI & Innovation`, `Product QA`, `Knowledge Management`,
`API Testing & Automation`, `UX & Documentation`

## Projects

### 1. AI Hackathon — 1st Place Win
...
- **Highlights**: 1st/11, Led requirements/UX/presentation, Customer Retention &
  Performance Monitoring
- **Color**: #f5a623

### 2. CRM Product Quality Initiative
...
- **Highlights**: 40% defect leakage reduction, Zero critical bugs in 6 sprints,
  Adopted by 3 teams
- **Color**: #1d6aff

### 3. Cross-Functional Domain Training Program
...
### 4. Postman POC — API & Performance Testing
...
### 5. Global UI Standards Documentation
...
- **Tags**: UI Standards, Accessibility, Documentation, Confluence, Design
  Systems
- **Highlights**: 200+ inconsistencies resolved, 3 product lines, 35% UI bug
  reduction
- **Color**: #da1f27
...
- Cards show: type chip, status, title, company/period, description, tags (first
  4), impact
