...
- **4 bullets**: WordPress theme customization → engagement & brand identity
- PSD to WordPress conversion → pixel-perfect, seamless handoff
- Elementor responsive pages → reduced bounce rates
- UI/UX optimization → increased satisfaction & engagement

### 5. UX Designer (Intern) — Arfa Software Technology Park

- **Period**: Oct 2021 — Dec 2021 (3 months)
- **4 bullets**: E-brochures & marketing materials → brand visibility
- Web interface design → intuitive UX, improved navigation
- UI prototyping → user needs alignment, smoother dev handoff
- Collaborative design improvements → user-centred UX enhancements
